...
Route::namespace('Api')->group(function() {
 ...
 //   Route::middleware(['samlauth'])->group(function () {
    ...
    Route::post('auth/azure/login','AuthController@loginWithAzure');
    //});
    Route::group(['middleware' => 'auth:sanctum'], function () {
        ...
        Route::middleware([
            ...
            // 'mypermission:'.Acl::PERMISSION_VIEW_MENU_MANAGE_SURVEY,
            //  'mypermission:'.Acl::PERMISSION_USER_VIEW_MENU_ANSWER_SURVEY
        ])->group(function () {
        ...
        Route::get('dashboard/respondent','SurveyResultController@GetAllRespondent')->middleware(['mypermission:'. Acl::PERMISSION_CREATE_SURVEY_LIST]);
    });
});
