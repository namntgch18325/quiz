      ...
      <div class="right-menu">
        ...
        >
          <div class="avatar-wrapper">
            <img :src="domain + avatar" class="user-avatar">
          </div>
    ...
    <div v-if="isUser == 'user'">
      <div class="header__user">
        <span class="header__user-logo">
          <label class="header__user-logo-arrow">></label>
          <div class="header__user-logo-text">accenture</div>
        </span>
        <span class="header__user-logo-title" @click="logout()">IS Quiz</span>
      </div>
    </div>
  </div>
</template>
