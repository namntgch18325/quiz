  ...
  <div class="app-container">
    ...
    >
      <el-form
        ...
        label-width="150px"
      >
        <el-form-item :label="$t('popup.tag.tClass_en')" prop="name_en" class="inputClassname">
          <el-input v-model="ruleForm.name_en" :placeholder="$t('popup.tag.pClass_en')" />
        </el-form-item>

        <el-form-item :label="$t('popup.tag.tClass_ja')" prop="name_ja" class="inputClassname">
  ...
  methods: {
    ...
    async DeleteMany() {
      ...
      if (this.multipleSelection.length === 0){
        ...
        const resDeleteOne = await deleteTag({
          id_list: dataDelete,
        ...
        if (resDeleteOne.message === 'Delete successfully'){ // Show messages and fetch data res
          ...
          this.listLoading = true;
          this.TagList = resDeleteOne.page_infor.data;
          ...
          this.$message({
            message: this.$t('popup.tag.notify.deleteFailed'),
            type: 'warning',
          });
        }
      }
