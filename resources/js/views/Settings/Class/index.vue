  ...
  <div class="app-container">
    ...
    >
      <el-form
        ...
        label-width="150px"
      >
        <el-form-item :label="$t('popup.class.tClass_en')" prop="name_en" class="inputClassname">
          <el-input v-model="ruleForm.name_en" :placeholder="$t('popup.class.pClass_en')" />
        </el-form-item>

        <el-form-item :label="$t('popup.class.tClass_ja')" prop="name_ja" class="inputClassname">
          <el-input v-model="ruleForm.name_ja" :placeholder="$t('popup.class.pClass_ja')" />
        </el-form-item>
...
export default {
  data() {
    return {
      ...
      rules: { // Rule validate
        name_en: [
          { required: true, message: this.$t('popup.class.rule.rname'), trigger: ['blur', 'change'] },
          { max: 255, message: this.$t('popup.class.rule.lname'), trigger: ['blur', 'change'] },
        ],
        name_ja: [
          { required: true, message: this.$t('popup.class.rule.rname'), trigger: ['blur', 'change'] },
          { max: 255, message: this.$t('popup.class.rule.lname'), trigger: ['blur', 'change'] },
  ...
  methods: {
    ...
    async DeleteMany() {
      ...
      if (this.multipleSelection.length === 0){
        ...
        const resDeleteOne = await deleteClass({
          id_list: dataDelete,
        ...
        if (resDeleteOne.message === 'Delete successfully'){ // Show messages and fetch data res
          ...
          this.listLoading = true;
          this.ClassList = resDeleteOne.page_infor.data;
          ...
          this.$message({
            message: this.$t('popup.class.notify.deleteFailed'),
            type: 'warning',
          });
        }
      }
